...
const changethemeBtn = document.querySelector(".switch-theme");
...
function navigationsTabInit(listItems,listitemActiveClass,contentItemShowClass){
...
navigationsTabInit(resumeListItems,'resume-list__item--active','resume-content--show');
navigationsTabInit(portfolioItems,'portfolio-item--active','portfolio-content--show');
